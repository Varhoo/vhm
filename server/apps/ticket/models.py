...
class Ticket(models.Model):
    ...
    pub_date = models.DateTimeField(_('pub date'), default=datetime.now, editable=False)
    status = models.IntegerField(choices=ENUM_STATUS,default=1,blank=True,null=True);
