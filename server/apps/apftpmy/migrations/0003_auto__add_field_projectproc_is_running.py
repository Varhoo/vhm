...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectProc.is_running'
        db.add_column(u'apftpmy_projectproc', 'is_running',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectProc.is_running'
        db.delete_column(u'apftpmy_projectproc', 'is_running')
    ...
    models = {
        u'apftpmy.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'u-8v-%fcpj^k6#o662cjtw9-69sh*2ppe8^qlowj^e(x-_%o^3'", 'max_length': '50'}),
        ...
        u'apftpmy.invoice': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['apftpmy.Account']"}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
        ...
        u'apftpmy.project': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['apftpmy.Account']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_modify': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 23, 0, 0)', 'blank': 'True'}),
        ...
        u'apftpmy.server': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'!cpo#yk0coux!qz2q*adzzmli#8=lap-nbu6aw8buvf))2l*3n'", 'max_length': '50'}),
