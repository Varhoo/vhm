...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'core_domain', 'server')
    ...
    models = {
        ...
        u'core.account': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'u08s+#sm+=irqnk-g$dks0-burk!+n1wkj&alu1bfxx3n9r#)t'", 'max_length': '50'}),
        ...
        u'core.server': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'2cy=1hnju5v1&2)tyiejh+v#qe@ru^@=@pthy%^ar&!=gkptye'", 'max_length': '50'}),
